...
<div class="container-fluid">
	<form action="index.php?" method="get" accept-charset="utf-8">
		...
		<div class="row mar-l-r">
			<div class="col-lg-5 ">
				<center>
					<img class="anhnen" src="admin/hinhanh/sanpham/<?php echo $row['AnhNen'] ?>">
				</center>
			</div>
			<div class="col-1"></div>
			<div class="col-lg-4 ">
				...
				<div class="card">
					<div class="khuyenmai">
						<h4>KHUYẾN MÃI</h4>
						<?php $sql2 = "SELECT MaKM from sanphamkhuyenmai where MaSP='$masp'";
					...
					<div class="khuyenmai">
						...
						<div class="form-group  ">
							<div class="btn-group  col-12 m-auto row">
								<?php $sql_mau = "select * from chitietmausp where MaSP='$masp'";
	...
	<div class="row mar-l-r">
		...
		<?php $sql4 = "select *from thongtinsp where MaSP='$masp'";
		$rs4 = mysqli_query($conn, $sql4);
		$row4 = mysqli_fetch_array($rs4); ?>
		<div class="col-lg-4 ">
			<h5>Thông số kỹ thuật</h5>
			<div class=" row fonttt">
